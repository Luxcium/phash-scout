...
type UnpackPromise<A> = A extends Promise<infer E> ? Promise<E> : Promise<A>;
export const immediateZalgo = <T = void>(
  value?: T,
  options?: TimerOptions | undefined
): UnpackPromise<T> => promisify(setImmediate)(value, options) as any;

export const timeoutZalgo = <T = void>(
  delay?: number | undefined,
  value?: T,
  options?: TimerOptions | undefined
): UnpackPromise<T> => promisify(setTimeout)(delay, value, options) as any;
...
/*
  ...
  //++ THIS SECTION IS NOT UNDER MIT LICENSE ---------------------------------------------------------------------------
  ...
  [...]
  //++ THIS SECTION WAS NOT UNDER MIT LICENSE --------------------------------------------------------------------------
